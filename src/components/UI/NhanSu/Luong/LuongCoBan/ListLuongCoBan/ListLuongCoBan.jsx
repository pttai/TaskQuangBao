...
import SearchLuongCoBan from '../SearchLuongCoBan/SearchLuongCoBan';

const ListLuongCoBan = (props) => {
  ...
  useEffect(() => {
    ...
    axios({
      method: 'GET',
      url: 'https://quanlyquangbao.herokuapp.com/api/luong/danhsachluongcoban',
    }).then((res) => {
      const { data } = res.data;
      const datas = [];
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'mucluong',
      key: 'mucluong',
      sorter: (a, b) => a.mucluong - b.mucluong,
    },
    {
      title: 'Vùng',
      dataIndex: 'vung',
  ...
  return (
    <div>
      <Breadcrumb style={{ margin: '16px 0', fontSize: 20 }}>
        ...
        <Breadcrumb.Item>Lương Cơ Bản</Breadcrumb.Item>
      </Breadcrumb>
      {/* <Button
        tyle='primary'
        style={{
